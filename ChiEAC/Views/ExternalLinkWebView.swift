...
private struct ExternalLinkRepresentable: UIViewRepresentable {
    let urlString: String
    ...
    class Coordinator: NSObject, WKNavigationDelegate {
        var parent: ExternalLinkRepresentable
        init(_ parent: ExternalLinkRepresentable) { self.parent = parent }
...
// Fallback notification names (also declared elsewhere)
